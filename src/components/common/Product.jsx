  ...
  return (
    <Products>
      {props.productApi.map((productCard) => {
        return (
          <ProductCardWrap key={productCard.product_id}>
            <LabelCard>HOT</LabelCard>

            <CartBtn type="button"></CartBtn>

            <ProductCardLink to={`/products/${productCard.product_id}`}>
              ...
              <p className="product-card-price">
                <strong>{priceDivide(productCard.price)}</strong>원
              </p>
            </ProductCardLink>
          </ProductCardWrap>
        );
